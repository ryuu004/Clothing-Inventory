...
<div class="container mx-auto p-6 space-y-6">
    <!-- Page Header -->
    <h1 class="text-2xl font-semibold text-gray-800">Edit Item</h1>
    ...
    <!-- Edit Form -->
    <form action="{{ route('items.update', $item->id) }}" method="POST" class="space-y-6 bg-white p-6 rounded shadow">
        @csrf
        @method('PUT')
